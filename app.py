...
@app.route('/json_agg', methods=['POST']) 
def json_agg():
    ...
    query = f"SELECT a.*, bikeid, duration_minutes, start_station_id FROM stations a inner join trips b on b.start_station_id = a.station_id WHERE start_time LIKE ('{specified_date}%')"
